...
@Service
public class HighGoUpgradeDao extends UpgradeDao {

    public static final Logger logger = LoggerFactory.getLogger(HighGoUpgradeDao.class);

    private HighGoUpgradeDao(DataSource dataSource) {
        super(dataSource);
    }

    @Override
    protected String initSqlPath() {
        return "create/release-1.2.0_schema/highgo";
    }
