...
package org.apache.dolphinscheduler.plugin.task.seatunnel.zeta;
...
public class SeatunnelZetaTask extends SeatunnelTask {

    private SeatunnelZetaParameters seatunnelParameters;
    public SeatunnelZetaTask(TaskExecutionContext taskExecutionContext) {
    ...
    public void init() {
        seatunnelParameters =
                JSONUtils.parseObject(taskExecutionContext.getTaskParams(), SeatunnelZetaParameters.class);
    ...
    public List<String> buildOptions() throws Exception {
        ...
        args.add(
                Objects.isNull(seatunnelParameters.getRunMode())
                        ? SeatunnelZetaParameters.RunModeEnum.LOCAL.getCommand()
